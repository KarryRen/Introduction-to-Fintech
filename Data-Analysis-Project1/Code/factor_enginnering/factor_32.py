...
df1 = pd.read_csv('./data/现金流量表(直接法).csv', usecols=['证券代码', '报表类型', '统计截止日期', '购建固定资产、无形资产和其他长期资产支付的现金'], low_memory=False)
