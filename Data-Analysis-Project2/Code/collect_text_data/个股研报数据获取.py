...
msg = json.loads(requests.post("https://reportapi.eastmoney.com/report/list2", data=demjson3.encode({"beginTime": '2019-01-01', "endTime": '2024-06-01', "pageNo": 1}), headers={"content-type": "application/json"}).text)
df = pd.DataFrame(msg["data"])
for i in range(2, msg["TotalPage"] + 1):
    msg_ = json.loads(requests.post("https://reportapi.eastmoney.com/report/list2", data=demjson3.encode({"beginTime": '2019-01-01', "endTime": '2024-06-01', "pageNo": i}), headers={"content-type": "application/json"}).text)
